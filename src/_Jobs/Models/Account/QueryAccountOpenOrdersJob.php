...
namespace Kraite\Core\_Jobs\Models\Account;
...
/*
 * QueryAccountOpenOrdersJob
 *
 * • Queries the exchange for open orders on the account.
 * • Stores the API result in the `api_snapshots` table for subsequent jobs.
 * • Used by VerifyTradingPairNotOpenJob to check if a symbol has pending orders.
 */
final class QueryAccountOpenOrdersJob extends BaseApiableJob
{
