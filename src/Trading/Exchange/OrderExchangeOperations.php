...
final class OrderExchangeOperations
{
    ...
    {
        return $this->order->position->account;
    }
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareOrderCancelProperties($this->order);
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareAlgoOrderCancelProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    public function apiModify(string|int|float|null $quantity = null, string|int|float|null $price = null): ApiResponse
    {
        ...
        $this->apiProperties = $this->apiMapper()->prepareOrderModifyProperties($this->order, $quantity, $price);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareOrderQueryProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlaceOrderProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlaceAlgoOrderProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareAlgoOrderQueryProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareStopOrderQueryProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->prepareStopOrderCancelProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlacePlanOrderProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlaceTpslOrderProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
        ...
        if ($finalResponse->result['success'] ?? false) {
            ...
            if (is_string($returnedClientOrderId)
                ...
                && $returnedClientOrderId !== $this->order->client_order_id) {
                $orderId = null;
            }
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlanOrderQueryProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
        ...
        return new ApiResponse(
            ...
            result: $this->apiMapper()->resolvePlanOrderQueryResponse(
                $this->apiResponse,
                (string) $this->order->exchange_order_id,
                (string) $this->order->type,
            )
        );
    }
    ...
    {
        $this->apiProperties = $this->apiMapper()->preparePlanOrderCancelProperties($this->order);
        $this->apiProperties->set('account', $this->apiAccount());
     ...
     */
    public function resolveSyncedPrice(mixed $incoming): mixed
    {
        if (! Math::isPositive($incoming)) {
            return $this->order->price;
        }

        return api_format_price((string) $incoming, $this->order->position->exchangeSymbol);
    }
     ...
     */
    public function resolveSyncedQuantity(mixed $incoming): mixed
    {
        if ($incoming === null || ! is_numeric($incoming)) {
            return $this->order->quantity;
        }

        return api_format_quantity((string) $incoming, $this->order->position->exchangeSymbol);
    }
    ...
    private function updateSyncedAttributes(array $attributes): void
    {
        ...
        foreach ($attributes as $attribute => $value) {
            if ($this->order->getAttribute($attribute) !== $value) {
        ...
        $this->order->fill($changedAttributes)->save();
    }
    ...
    private function fetchTpslOrderIdFromPosition(): ?string
    {
        ...
        $symbol = $this->order->position->exchangeSymbol->parsed_trading_pair;
        $direction = $account->isHedgeMode()
            ? mb_strtoupper($this->order->position->direction)
            : 'BOTH';
        ...
        $isStopLoss = in_array(mb_strtoupper(str_replace('-', '_', $this->order->type)), ['STOP_MARKET', 'STOP_LOSS'], true);
